		...
		for (int segmentIndex = 0; segmentIndex < firstYearsArray.size(); segmentIndex++)
		{
			...
			if (kevents.size() >= 2)
			{
				...
				if (keventsinadj.size() >= 2)
				{
					...
					if ((Integer) firstYearOfProcess.intValue() > (Integer) chronologyYears.get(0).intValue())
					{
					...
					if ((Integer) lastYearOfProcess.intValue() < (Integer) chronologyYears.get(chronologyYears.size() - 1).intValue())
					{
