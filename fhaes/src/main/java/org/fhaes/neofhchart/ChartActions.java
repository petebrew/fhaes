...
public class ChartActions {
	 ...
	 * protected JRadioButton dashTickStyle = new JRadioButton("Dashed Line"); protected JRadioButton lineTickStyle = new
	 * JRadioButton("Solid Line");
	 * 
	 * protected ButtonGroup composite_group = new ButtonGroup(); protected JRadioButton fireAndInjuryEvents = new
	 * JRadioButton("Fire and Injury Events"); protected JRadioButton injuryOnlyEvents = new JRadioButton("Injury Events Only"); protected
	...
	public ChartActions(NeoFHChart neochart) {
		...
		actionZoomIn = new FHAESAction("Zoom in", "zoom_in.png", "Zoom in", "Zoom in") {
			...
			public void actionPerformed(ActionEvent event) {
				...
				Action action = map.get(JSVGCanvas.ZOOM_IN_ACTION);
		...
		actionZoomOut = new FHAESAction("Zoom out", "zoom_out.png", "Zoom out", "Zoom out") {
			...
			public void actionPerformed(ActionEvent event) {
				...
				ActionMap map = neoFHChart.svgCanvas.getActionMap();
				Action action = map.get(JSVGCanvas.ZOOM_OUT_ACTION);
				action.actionPerformed(new ActionEvent(this, ActionEvent.ACTION_PERFORMED, null));
			}
		};
