...
public class TimeAxisBuilder {
	...
	protected static Element getTimeAxis(Document doc, String svgNS, int height, int firstChartYear, int lastChartYear) {
		...
		timeAxis.setAttributeNS(null, "stroke", FireChartConversionUtil.colorToHexString(Color.BLACK));
	...
	protected static Element getMajorTick(Document doc, String svgNS, int yearPosition, int chartWidth, int height, int firstChartYear,
		...
		majorTick.setAttributeNS(null, "stroke", FireChartConversionUtil.colorToHexString(Color.BLACK));
	...
	protected static Element getMinorTick(Document doc, String svgNS, int yearPosition, int chartWidth, int height, int firstChartYear,
		...
		minorTick.setAttributeNS(null, "stroke", FireChartConversionUtil.colorToHexString(Color.BLACK));
	...
	protected static Element getHighlightLine(Document doc, String svgNS, int yearPosition, int chartWidth, int height, int firstChartYear,
		...
		highlightLine.setAttributeNS(null, "stroke",
				FireChartConversionUtil.colorToHexString(App.prefs.getColorPref(PrefKey.CHART_HIGHLIGHT_YEARS_COLOR, Color.YELLOW)));
	...
	protected static Element getVerticalGuide(Document doc, String svgNS, int yearPosition, int chartWidth, int height, int firstChartYear,
		...
		verticalGuide.setAttributeNS(null, "stroke",
				FireChartConversionUtil.colorToHexString(App.prefs.getColorPref(PrefKey.CHART_VERTICAL_GUIDE_COLOR, Color.BLACK)));
