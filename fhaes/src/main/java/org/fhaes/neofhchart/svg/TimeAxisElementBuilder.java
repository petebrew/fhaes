...
public class TimeAxisElementBuilder {
	 ...
	 * @return majorTick
	 */
	protected static Element getMajorTick(Document doc, int yearPosition, int chartWidth, int height, int firstChartYear, int lastChartYear) {
	 ...
	 * @return minorTick
	 */
	protected static Element getMinorTick(Document doc, int yearPosition, int chartWidth, int height, int firstChartYear, int lastChartYear) {
