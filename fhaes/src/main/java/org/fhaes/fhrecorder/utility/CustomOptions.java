 ...
 *     
 *     1) This file was added to hold all of the information from the custom
 *     options dialog for the summary and graphics tabs.
 ******************************************************************************/
...
public class CustomOptions {
	...
	public enum DataItem {
		...
		DORMANT_SEASON("Dormant season"), EARLY_EARLYWOOD("Early earlywood"), MIDDLE_EARLYWOOD("Middle earlywood"), LATE_EARLYWOOD(
				"Late earlywood"), LATEWOOD("Latewood"), UNDETERMINED("Undetermined"), BLANK_YEARS("Blank years");

		// Temporarily removing Recording years
		/*
		 * DORMANT_SEASON("Dormant season"), EARLY_EARLYWOOD("Early earlywood"), MIDDLE_EARLYWOOD("Middle earlywood"), LATE_EARLYWOOD(
		 * "Late earlywood"), LATEWOOD("Latewood"), UNDETERMINED("Undetermined"), RECORDING_YEARS("Recording years"), BLANK_YEARS(
		 * "Blank years");
		 */
	...
	public CustomOptions() {
		...
		defaultColors = Arrays.asList(new Color(0x004586), new Color(0xff420e), new Color(0xffd320), new Color(0x579d1c), new Color(
				0x7e0021), new Color(0x83caff));
	}
