...
/**
 * CompareSampleFirstYearAscending Class. This class is used to compare the difference between the starting years of two FHX2samples in
 * ascending order.
 * 
...
public class CompareSampleFirstYearAscending implements Comparator<FHX2_Sample> {
	...
	/**
	 * Compares two samples according to their respective starting years. This is done in ascending order.
	 * 
	...
	public int compare(FHX2_Sample t, FHX2_Sample t1) {
		...
		return s1.getSampleFirstYear() - s2.getSampleFirstYear();
	}
}
