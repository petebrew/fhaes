 ...
 *     2) Panels and labels on the GUI were rearranged to address usability
 *     improvement #3 on our original list of maintenance requests.
 ******************************************************************************/
...
public class SampleInputPanel extends javax.swing.JPanel implements ChangeListener, PropertyChangeListener {
	...
	private void createSampleHeaderPanel() {
		...
		sampleNameContainer.setBorder(new MatteBorder(0, 0, 1, 0, (Color) new Color(128, 128, 128)));
	...
	public void redrawSampleDataPanel(int selectedSampleIndex) {
		...
		if (selectedSampleIndex > -1)
		{
			...
			if (selectedSample != null)
			{
				...
				firstYearSpinner.setValue((Integer) selectedSample.getSampleFirstYear());
				lastYearSpinner.setValue((Integer) selectedSample.getSampleLastYear());
