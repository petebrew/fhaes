 ...
 *     
 *     1) This GUI was added during our implementation of an error handling
 *     system which the program will run in the event that it attempts to load
 *     an erroneous FHX2 file.
 ******************************************************************************/
