 ...
 *     
 *     1) This file was added to allow for the customization of color bars.
 ******************************************************************************/
...
public class CustomizeDialog extends javax.swing.JDialog {
	...
	public CustomizeDialog(javax.swing.JPanel parent, boolean modal) {
		...
		getContentPane().setLayout(
				new MigLayout("", "[115px,grow][115px,grow][115px,grow][115px,grow][115px,grow][115px,grow][115px,grow]",
						"[][][][][grow][]"));
