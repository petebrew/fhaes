...
public class EventTable extends JTable {
	...
	public enum EventTypes {
		FIRE_SCAR("Fire Scar", 0), OTHER_INJURY("Other Injury", 1);
	...
	public enum EventSeasons {
		DORMANT("Dormant season", 'D', 0), EARLY_EARLY("Early earlywood", 'E', 1), MIDDLE_EARLY("Middle earlywood", 'M', 2), LATE_EARLY(
				"Late earlywood", 'L', 3), LATEWOOD("Latewood", 'A', 4), UNDETERMINED("Undetermined", 'U', 5);
	 ...
	 */
	public enum Columns {
		EVENT_TYPE("Event Type", 0), EVENT_SEASON("Event Season", 1), EVENT_YEAR("Event Year", 2);
