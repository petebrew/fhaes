 ...
 *     2) Added a message trigger in confirmButtonActionPerformed() which tells
 *     the statusTextBox to clear its contents; this is part of the fix that is
 *     addressed in missing feature #2 in our original list of maintenance
 *     requests.
 ******************************************************************************/
	...
	private void confirmButtonActionPerformed(java.awt.event.ActionEvent evt) {
		...
		if (sampleNameTextBox.getText().length() < 3)
		{
			FireHistoryRecorder.updateStatusBarMessage(MessageType.WARNING, Color.red,
					StatusBarPanel.MINIMUM_SAMPLE_NAME_LENGTH_MESSAGE_ID, "Sample name must be at least 3 characters in length.");
