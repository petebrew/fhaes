...
/**
 * LargeDatasetWarningDialog Class.
 */
public class LargeDatasetWarningDialog extends JDialog {
	...
	public static Boolean showWarning(Integer fileCount) {
		...
		{
			LargeDatasetWarningDialog dialog = new LargeDatasetWarningDialog(fileCount);
	 ...
	 * Create the dialog.
	 */
	public LargeDatasetWarningDialog(Integer fileCount) {
