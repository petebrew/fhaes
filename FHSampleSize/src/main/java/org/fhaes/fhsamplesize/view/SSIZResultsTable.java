...
public class SSIZResultsTable extends JXTable {
	 ...
	 */
	public enum Columns {
		N("N", 0), SEGMENT_START("Seg Start", 1), SEGMENT_END("Seg End", 2), MEAN_EVENTS_PER_CENTURY("Mean", 3), MEDIAN_EVENTS_PER_CENTURY(
				"Median", 4), CONFIDENCE_INTERVAL_95("CI 95", 5), CONFIDENCE_INTERVAL_99("CI 99", 6), WEIBULL_MEAN("Weibull Mean", 7), WEIBULL_MEDIAN(
				"Weibull Median", 8), WEIBULL_CONFIDENCE_INTERVAL_95("Weibull CI95", 9), WEIBULL_CONFIDENCE_INTERVAL_99("Weibull CI99", 10);
